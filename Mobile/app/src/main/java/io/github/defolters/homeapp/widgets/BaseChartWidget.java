...
import io.github.defolters.homeapp.apputils.Colors;
import io.github.defolters.homeapp.apputils.Formatters;
import io.github.defolters.homeapp.domain.Chart;
import io.github.defolters.homeapp.domain.GroupBy;
import io.github.defolters.homeapp.utils.ChartMath;
import io.github.defolters.homeapp.utils.ColorUtils;
import io.github.defolters.homeapp.widget.BaseChartView;
import io.github.defolters.homeapp.widget.ChartFinderView;
import io.github.defolters.homeapp.widget.ChartView;
...
public abstract class BaseChartWidget extends FrameLayout {
    ...
    private void showSources(Chart.Source[] sources, boolean[] states) {
        ...
        for (int i = 0, size = sources.length; i < size; i++) {
            final Chart.Source source = sources[i];
            final int pos = i;
